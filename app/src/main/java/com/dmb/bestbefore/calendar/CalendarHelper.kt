package com.dmb.bestbefore.calendar
...
class CalendarHelper(private val context: Context) {
    ...
    fun createCalendarEvent(
        ...
        val values = android.content.ContentValues().apply {
            ...
            put(CalendarContract.Events.TITLE, "🎉 $roomName - Time Capsule Unlock")
            put(CalendarContract.Events.DESCRIPTION, description ?: "Your time capsule room \"$roomName\" will unlock at this time!")
            put(CalendarContract.Events.DTSTART, notificationTime)
            put(CalendarContract.Events.DTEND, notificationTime + (30 * 60 * 1000)) // 30 minute duration
